        ...
        <CarouselContent>
          <CarouselItem className="md:min-h-screen w-full py-10 relative">
            ...
            <div className="flex flex-col justify-start items-start md:w-2/3 w-full md:pl-20 pl-3 ">
              <h2 className="md:text-5xl text-3xl font-bold md:mt-20 mt-10 md:mb-4 mb-2 text-white">
                Summer Offer
              </h2>
              <h2 className="md:text-5xl text-3xl font-bold md:mb-20 mb-10 text-white">
                2024 Collections
              </h2>
              <Button
                variant={"secondary"}
                className="shadow-sm shadow-slate-400 px-12 py-8"
              >
                SHOP NOW
              </Button>
            </div>
